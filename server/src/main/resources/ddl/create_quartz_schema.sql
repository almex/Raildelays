...
(
  ...
  REPEAT_COUNT NUMERIC (7
) NOT NULL,
  REPEAT_INTERVAL NUMERIC (12
) NOT NULL,
  TIMES_TRIGGERED NUMERIC (10
) NOT NULL,
PRIMARY KEY (SCHED_NAME, TRIGGER_NAME, TRIGGER_GROUP
),
...
(
  ...
  FIRED_TIME NUMERIC (13
) NOT NULL,
  SCHED_TIME NUMERIC (13
) NOT NULL,
...
(
  ...
  LAST_CHECKIN_TIME NUMERIC (13
) NOT NULL,
  CHECKIN_INTERVAL NUMERIC (13
) NOT NULL,
