...
public class LineStopJpaDaoIT {
	...
	public void createTest() {
		Assert.assertNotNull("Creation should return a result", lineStopDao.save(new LineStop(new Train("466"), new Station("Liège-Guillemins"), new TimestampDelay(), new TimestampDelay())));
	}
	...
	public void retrieveTest() {
		...
		Assert.assertEquals("You should have a certain number of results.", 0, lineStopDao.findByTrain("466", new java.sql.Date(new Date().getTime())).size());
	}
